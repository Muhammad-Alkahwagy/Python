...
result =subprocess.run(['avr-gcc', '-mmcu=atmega32', '-Os', '-c', 'TMR0_Program.c', '-o', 'TMR0_Program.o'])

# Link the object files
result =subprocess.run(['avr-gcc', '-mmcu=atmega32', '-Os', 'main.o', 'DIO_Program.o','TMR0_Program.o' ,'-o','output.elf'])
